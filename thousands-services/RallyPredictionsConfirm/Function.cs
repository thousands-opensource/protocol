...
namespace RallyPredictionsConfirm;
...
public class Function
{
    ...
    public async Task<APIGatewayProxyResponse> FunctionHandler(APIGatewayProxyRequest proxyRequest, ILambdaContext context)
    {
        ...
        string predictionId = confirmPredictionRequest.PredictionId;
        bool choice = confirmPredictionRequest.Choice;
        ...
        try
        {
            ConfirmPredictionResult confirmPredictionResult = await _predictionService.ConfirmPrediction(priceQuoteGuid, userId, choice, credits, predictionId);
