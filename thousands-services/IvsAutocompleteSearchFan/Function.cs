...
namespace IvsAutocompleteSearchFan;


public class AutocompleteSearchFanResponse
{
    [JsonPropertyName("success")]
    public bool Success { get; set; }
    [JsonPropertyName("data")]
    public List<SkyboxFan> Data { get; set; } = new List<SkyboxFan>();
    [JsonPropertyName("errorMessage")]
    public string? ErrorMessage { get; set; }
}

public class AutocompleteSearchFanRequest
{
...
public class Function
{
    ...
    public async Task<APIGatewayProxyResponse> FunctionHandler(APIGatewayProxyRequest proxyRequest, ILambdaContext context)
    {
        ...
        AutocompleteSearchFanRequest? autocompleteSearchFanRequest;
        try
        {
            autocompleteSearchFanRequest = JsonSerializer.Deserialize<AutocompleteSearchFanRequest>(proxyRequest.Body);
            if (autocompleteSearchFanRequest == null)
            {
        ...
        string stageId = autocompleteSearchFanRequest.StageId;
        string skyboxId = autocompleteSearchFanRequest.SkyboxId;
        string fanName = autocompleteSearchFanRequest.FanName;
        ...
        if (fanName == null)
        {
            return ThousandsResponse($"Invalid fanName", $"ThousandsWarning: Invalid fanName - {fanName}", null, 200);
        }
        ...
        List<SkyboxFan> autocompleteSearchFanResult = await _skyboxService.SearchFans(userId, fanName, stageId, skyboxId);
        AutocompleteSearchFanResponse autocompleteSearchFanResponse = new AutocompleteSearchFanResponse()
        {
            Data = autocompleteSearchFanResult,
            Success = true
        };

        return ThousandsResponse("", "ThousandsSuccess: Successfully search fan names", autocompleteSearchFanResponse, 200);
    }

    private APIGatewayProxyResponse ThousandsResponse(string uiMessage, string logMessage, AutocompleteSearchFanResponse? response = null, int statusCode = 500)
    {
        Console.WriteLine(logMessage);
        AutocompleteSearchFanResponse autocompleteSearchFanResponse = response ?? new AutocompleteSearchFanResponse()
        {
        ...
        return new APIGatewayProxyResponse
        {
            ...
            Body = JsonSerializer.Serialize(autocompleteSearchFanResponse),
