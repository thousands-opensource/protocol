...
import Spawn_Of_Spord_Horizontal from "@/public/images/WildfileAssets/Collections/pre-alpha/Spawn_Of_Spord_Horizontal.webp";
import Spawn_Of_Spord_Vertical from "@/public/images/WildfileAssets/Collections/pre-alpha/Spawn_Of_Spord_Vertical.webp";
...
export const pinImgSx = (tokenId: string, owned: boolean) => {
     ...
     * @returns string
     */
    const tokenImgAsset = (tokenId: string, owned: boolean) => {
...
export const swagSetsStyles: SwagSetStyles = {
    [MELEE_ON_THE_METEOR]: {
        ...
        collectThemAllWidth: ["90px", "144px", "200px", "164px"],
    },
    [COMMUNITY_GATHERINGS]: {
        ...
        rightPanelPaddingY: ["32px", "32px", "32px", "62px"],
        rightPanelHeight: ["370px", "650px", "900px", "auto"],
        rightPanelBackgroundSize: "cover",
        rightPanelBackgroundImageUrl: `url(${STRIPE_VERTICAL_BACKGROUND_IMAGE})`,
    ...
    [MOODS_OF_BOLGAR]: {
        ...
        templateColumns: `repeat(2, 1fr)`,
        rightPanelTop: "50%",
        rightPanelHeight: ["194px", "357px", "600px", "auto"],
        ...
        collectThemAllWidth: ["80px", "144px", "263px", "144px"],
        collectThemAllInset: ["-4px 0 0 -8px", "-4px 0 0 -20px"],
    },
    [SPAWN_OF_SPORD]: {
        backgroundBorderGradient: `linear-gradient(to bottom, ${THEME_COLOR_PLATINUM}, ${THEME_COLOR_BRIGHT_GRAY}, ${THEME_COLOR_BRIGHT_GRAY}, ${THEME_COLOR_GHOST_WHITE})`,
