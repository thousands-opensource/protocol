...
interface WildfileThemedTextSVGProps {
    titleText: string;
    fontSize: number;
}

/**
 * React component that displays the new feature text SVG.
 */
const WildfileThemedTextSVG = ({
    titleText,
    fontSize,
}: WildfileThemedTextSVGProps) => {
    return (
        <Box
            as="svg"
            id="Layer_2"
...
export default WildfileThemedTextSVG;
