import { UserSettingsContextInterface } from "@/contexts/userSettingsContext";
...
export function useSavedValuesFromLocalStorage() {
    ...
    const configRef = useRef<VideoResolutionConfig>(
    ...
    const savedValues: UserSettingsContextInterface = {
        channelType,
        setChannelType,
    ...
    switch (resolution) {
        case "1080":
            config = {
                ...
                bitrate: channelType === CHANNEL_TYPES.BASIC ? 3500 : 8500,
            };
            break;
        case "720":
            config = {
                ...
                bitrate: channelType === CHANNEL_TYPES.BASIC ? 3500 : 6500,
            };
            break;
        case "480":
            config = {
                ...
                bitrate: channelType === CHANNEL_TYPES.BASIC ? 1500 : 3500,
            };
            break;
        case "360":
            config = {
